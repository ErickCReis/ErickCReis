...
{isBlogPostPublished(new Date("2026-09-05")) && (
  ...
  <blockquote>
    <p>
      This post describes the original JSON transport. The current implementation uses a compact
      binary protocol, covered in{" "}
      <a href="/blog/four-byte-cursor-presence">A four-byte protocol for cursor presence</a>.
    </p>
  </blockquote>
)}
