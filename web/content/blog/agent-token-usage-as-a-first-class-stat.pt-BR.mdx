---
title: "Uso de tokens de agentes como estatística de primeira classe"
...
date: "2026-09-05"
tags: [agentes, telemetria, tokens]
---

import { TokenUsageMergeLab } from "@web/features/blog-series/labs/token-usage-merge-lab";
...
O laboratório começa com uma janela antiga de `codex/laptop` e outra atual de `claude/laptop`. Mantenha a chave selecionada para antecipar uma substituição ou troque o `sourceId` para `server` e veja uma combinação aditiva. Alterar o horário de geração também revela a diferença entre a atualização de cada origem e o indicador único do conjunto.
