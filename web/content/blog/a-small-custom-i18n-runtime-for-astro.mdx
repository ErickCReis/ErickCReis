...
The [blog layer](/content/the-blog-layer-static-pages-live-view-counts) treats English and Brazilian Portuguese articles as separate MDX files. That is the right boundary for long-form writing: translation is editorial work, not a string lookup.
...
<TranslationCatalogLab client:visible locale="en-US" />
