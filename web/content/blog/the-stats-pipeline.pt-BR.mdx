...
O pipeline permite que cada fonte mantenha o próprio relógio enquanto a página enxerga uma única camada dinâmica e coerente. O próximo post desce para baixo das rotas de API e explica como o mesmo processo Bun também serve a saída estática do Astro como o site em produção.
