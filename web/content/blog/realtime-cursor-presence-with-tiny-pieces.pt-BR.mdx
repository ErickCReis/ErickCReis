...
A funcionalidade funciona porque não exijo que ela seja maior do que é. Uma identidade definida pelo servidor, uma mensagem de posição validada, envios limitados, um socket que se reconecta e um estado temporário no cliente são suficientes para dar vida a uma página que, fora isso, continua estática.
