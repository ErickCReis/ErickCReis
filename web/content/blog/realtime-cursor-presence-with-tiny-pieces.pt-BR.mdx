...
import { isBlogPostPublished } from "@web/lib/blog-publication";

{isBlogPostPublished(new Date("2026-09-05")) && (

  <blockquote>
    <p>
      Este post descreve o transporte JSON original. A implementação atual usa um protocolo binário
      compacto, explicado em{" "}
      <a href="/pt-BR/blog/four-byte-cursor-presence">
        Um protocolo de quatro bytes para presença de cursores
      </a>{"."}
    </p>
  </blockquote>
)}
