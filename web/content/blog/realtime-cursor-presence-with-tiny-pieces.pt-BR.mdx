...
> Este post descreve o transporte JSON original. A implementação atual usa um protocolo binário compacto, explicado em [Um protocolo de quatro bytes para presença de cursores](/pt-BR/blog/four-byte-cursor-presence).
