...
A [camada do blog](/pt-BR/blog/the-blog-layer-static-pages-live-view-counts) trata os artigos em inglês e português brasileiro como arquivos MDX separados. Essa é a fronteira certa para textos longos: tradução é um trabalho editorial, não uma consulta em um catálogo de strings.
