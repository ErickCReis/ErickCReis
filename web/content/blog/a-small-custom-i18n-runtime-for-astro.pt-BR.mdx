...
Criei uma integração sob medida para esse requisito mais estreito. Ela não é um framework genérico de internacionalização. A integração coleta strings de origem estáticas, gera catálogos TypeScript indexados por hashes, expõe um módulo virtual e usa o texto em inglês sempre que uma tradução está ausente.
