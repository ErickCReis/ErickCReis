...
description: Como duas APIs externas se tornam pequenos painéis dinâmicos com políticas diferentes de polling, cache e falhas.
date: "2026-07-25"
...
Um painel mostra o que estou ouvindo no [Spotify](https://developer.spotify.com/documentation/web-api). Outro resume minha atividade recente a partir da [API GraphQL do GitHub](https://docs.github.com/pt/graphql). Juntos, eles fazem a página inicial dizer algo sobre o presente em vez de apenas listar trabalhos do passado.

Eles aparecem lado a lado como peças de telemetria, mas suas fontes se comportam de formas diferentes. A reprodução muda em segundos e pode nem existir. Os dados de contribuições mudam devagar e continuam úteis depois de uma reinicialização. Tratar os dois apenas como “consultar uma API de tempos em tempos” esconderia as decisões que os mantêm úteis.
...
Os 84 retratos mais recentes vivem apenas na memória do processo. Eles permitem que o painel encontre a faixa anterior, mas não formam um histórico de reprodução. Reiniciar o servidor os apaga, e essa é uma distinção útil: o site exibe o contexto da reprodução sem criar mais um registro permanente sobre ela.
