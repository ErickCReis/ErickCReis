...
import { DeploymentShapeLab } from "@web/features/blog-series/labs/deployment-shape-lab";
...
<DeploymentShapeLab client:visible locale="pt-BR" />
...
Self-hosting deixou esta aplicação mais simples de entregar, não mais simples de operar. O formato ficou menor, não magicamente mais seguro. Troquei fronteiras gerenciadas por responsabilidades que consigo enxergar: um processo, um diretório de dados, um problema de backup e uma camada em tempo real que ainda preciso fortalecer.
