...
Esses caminhos se encontram no container em execução, mas carregam coisas diferentes. Um novo deploy substitui o container, enquanto o diretório `/app/data` montado permanece.
