...
Este blog faz parte do mesmo sistema dinâmico, mas não precisa se transformar em uma aplicação de publicação dinâmica para participar. O Astro gera o conteúdo. O Elysia adiciona um único valor de runtime: quantas visualizações deduplicadas cada versão de idioma recebeu.
...
É a mesma fronteira usada na página inicial: o documento existe sem estado no cliente, e o JavaScript entra onde um valor dinâmico acrescenta algo útil.
