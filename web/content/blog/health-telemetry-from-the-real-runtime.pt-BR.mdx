...
```mermaid center
flowchart TB
  Runtime["Runtime<br/>CPU · memória · bateria"] --> Stats["Módulos de estatísticas"]
  Network["Rede<br/>uptime · heartbeats"] --> Stats
  Stats --> Bootstrap["GET /stats/history"]
  Stats --> Stream["GET /stats/stream<br/>SSE"]
  Bootstrap --> Stores["Stores limitados<br/>do Solid"]
  Stream --> Stores
  Stores --> Panels(["Painéis de sistema<br/>uptime · presença"])
```
